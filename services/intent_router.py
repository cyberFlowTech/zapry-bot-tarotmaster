...
7. "帮我算一卦" → tarot
8. "我好难过" → chat（倾诉）
9. "你记得我吗" → memory（想看记忆档案概况）
22. "你记得我去哪里滑雪吗" → chat（问的是具体的事情，应该在对话中回答，不是查看档案）
23. "你记得我说过什么" → chat（问的是具体内容，让AI从对话历史中回答）
24. 只有"你记得我吗""你记得我什么""你了解我吗"这种泛泛的问题才返回 memory
...
_KEYWORD_PATTERNS = [
    ...
    (re.compile(r"^(你|晚晴).{0,3}(记得|记住|知道).{0,3}(我什么|关于我|我吗)$"), "memory", None),
